    ...
    <div class="col-md-4 col-md-offset-4">
      ...
      <div class="widget widget-blue">
        <div class="widget-title">
          <h3 class="text-center"><i class="fa fa-lock"></i> Exenox Admin</h3>
        </div>
        <div class="widget-content">
          <form action="access.php" role="form" method="post">
            <div class="lined-separator"><h3>LOGIN</h3></div>
            ...
            <button class="btn btn-primary btn-rounded btn-iconed" name="login">
              Log me in <i class="fa fa-arrow-right"></i>
            </button>
