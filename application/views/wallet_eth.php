            ...
            <div id="page-wrapper">
				<div class="row page-titles">
					<div class="col-md-5 align-self-center">
						<h3 class="text-themecolor">ETH Wallet </h3>
					</div>
					<div class="col-md-7 align-self-center">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
							<li class="breadcrumb-item active">ETH Wallet </li>
						</ol>
					</div>
				</div>
...
<?php
		$fetchPosts = file_get_contents("https://api.blockcypher.com/v1/eth/main/addrs/$addr/full?limit=50");
...
?> 
				...
				<div class="row">
					 ...
					 <div class="col-md-6 col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title m-b-0">ETH Deposit</h4>
                                    </div>
                                    <div class="card-body">
							...
							<input style="padding:5px;border-radius:5px;width:85%;text-align:center" type="text" value="<?=$addr?>"  id="secretCode"  readonly><br><br>
					 ...
					 <div class="col-md-6 col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title m-b-0">ETH Withdraw</h4>
                                    </div>
                                    <div class="card-body">
